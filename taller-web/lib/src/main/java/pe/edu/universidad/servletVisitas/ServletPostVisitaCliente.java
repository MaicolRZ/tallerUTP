...
@WebServlet("/ServletPostVisitaCliente")


public class ServletPostVisitaCliente extends HttpServlet{
private static final long serialVersionUID = 1L;

public ServletPostVisitaCliente() { 
 super();}
//crear nuevo usuario cliente
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		rd=request.getRequestDispatcher("PaginaCliente/tarjetas.jsp");
