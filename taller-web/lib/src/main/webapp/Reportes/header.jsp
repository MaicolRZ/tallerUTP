...
<section class="full-box cover dashboard-sideBar">
		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box text-uppercase text-center text-titles dashboard-sideBar-title">
				TALLER UTP <i class="zmdi zmdi-close btn-menu-dashboard visible-xs"></i>
			</div>
			<!-- SideBar User info -->
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					<a href="#!" class="btn-sideBar-SubMenu">
						<i class="zmdi zmdi-account-add zmdi-hc-fw"></i> Mantenimiento <i class="zmdi zmdi-caret-down pull-right"></i>
					</a>
					<ul class="list-unstyled full-box">
						
						<li>
							<a href="../tecnico.jsp"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i> Tecnicos</a>
						</li>

						<li>
							<a href="../cliente.jsp"><i class="zmdi zmdi-male-female zmdi-hc-fw"></i> Clientes</a>
						</li>
						<li>
							<a href="../piezas.jsp"><i class="zmdi zmdi-case zmdi-hc-fw"></i> Piezas</a>
						</li>
					</ul>
				</li>
	...
	<section class="full-box dashboard-contentPage">
		...
		<!-- Content page Desde esta pagina se debe usar el include -->
		
	</section>

	<!-- Notifications area hasta aca va el include-->
	  	...
	  	<div class="modal-dialog" role="document">
		    <div class="modal-content">
			    ...
			    <div class="modal-body">
			        <p>
						home html linea 320 editar ayuda
			        </p>
			    </div>
